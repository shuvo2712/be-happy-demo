          ...
          <div className="w-full order-2 space-y-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
              <div className="flex items-start gap-2 sm:gap-3 rounded-2xl bg-slate-100 border border-slate-200 px-3 py-2.5 sm:px-4 sm:py-3">
                ...
                <div>
                  <p className="text-xs sm:text-sm font-bold text-slate-900">Fully Verified Landlords</p>
                  <p className="text-[10px] sm:text-xs text-slate-500 leading-relaxed mt-0.5">We verify all ownership documents so you avoid deposit scams.</p>
                </div>
              </div>
              <div className="flex items-start gap-2 sm:gap-3 rounded-2xl bg-slate-100 border border-slate-200 px-3 py-2.5 sm:px-4 sm:py-3">
                <div className="h-7 w-7 sm:h-8 sm:w-8 shrink-0 rounded-xl bg-teal-500/10 border border-teal-500/20 flex items-center justify-center text-teal-600">
                ...
                <div>
                  <p className="text-xs sm:text-sm font-bold text-slate-900">Bilingual Negotiation</p>
                  <p className="text-[10px] sm:text-xs text-slate-500 leading-relaxed mt-0.5">Our team mediates landlord discussions and drafts formal contracts.</p>
                </div>
              </div>
            </div>
