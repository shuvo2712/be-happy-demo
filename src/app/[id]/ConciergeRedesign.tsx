    ...
    <div className="flex flex-col min-h-screen bg-slate-50">
          ...
          <div className="flex flex-row items-start gap-4 sm:gap-6 md:gap-8">
            ...
            <div className="max-w-2xl">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-teal-500/10 px-3 py-1 text-xs font-semibold text-teal-400 ring-1 ring-inset ring-teal-500/20">
                <ShieldCheck className="h-3.5 w-3.5" /> White-Glove Concierge — Dhaka
              </span>
              <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-white sm:text-5xl">
                One Message. Everything Arranged.
              </h1>
              <p className="mt-4 text-base sm:text-lg text-slate-400 leading-relaxed">
                Hotels, flights, professional drivers, rental vehicles, or a trusted housemate — our dedicated concierge team in Dhaka handles every detail so you can focus on what matters.
              </p>
            </div>
          </div>
        </FadeInSection>
      ...
      <main className="mx-auto max-w-7xl w-full px-6 lg:px-8 py-10 sm:py-14">
        <FadeInSection delay={100}>
          ...
          <div className="w-full lg:w-[500px] shrink-0 order-1 lg:order-2 lg:sticky lg:top-24">
            ...
            <div className="mb-4 flex items-center justify-between rounded-xl bg-white px-4 py-2.5 shadow-sm ring-1 ring-slate-100">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-slate-700">Concierge Team Online Now</span>
              </div>
              <span className="text-[10px] font-bold tracking-wider text-slate-400 uppercase">Dhaka GMT+6</span>
            </div>
          ...
          <div className="w-full flex-1 order-2 lg:order-1 space-y-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="rounded-2xl bg-white border border-slate-100 p-6 shadow-sm">
                ...
                <h3 className="text-base font-bold text-slate-900 mb-1">Fully Vetted Partners</h3>
                <p className="text-xs text-slate-500 leading-relaxed">
                  All hotels, drivers, and car rental vendors are personally vetted by our team for safety, reliability, and fair pricing.
                </p>
              </div>
              <div className="rounded-2xl bg-white border border-slate-100 p-6 shadow-sm">
                <div className="h-10 w-10 rounded-xl bg-teal-50 border border-teal-100 flex items-center justify-center text-teal-600 mb-4">
                ...
                <h3 className="text-base font-bold text-slate-900 mb-1">Same-Day Confirmation</h3>
                <p className="text-xs text-slate-500 leading-relaxed">
                  Submit your request before noon and our concierge team will confirm everything within the same business day.
                </p>
              </div>
            </div>
